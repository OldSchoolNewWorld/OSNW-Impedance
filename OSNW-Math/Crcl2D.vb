...
#Region "Constructors"
            ...
            ''' Thrown when <paramref name="radius"/> is negative.
            ''' </exception>"
            Public Sub New(ByVal center As Math.D2.Point,
                           ByVal radius As System.Double)
...
#Region "Methods"
            ...
            ''' values.
            ''' </remarks>
            Public Shared Function CirclesIntersect(ByVal circle0 As Circle,
                ByVal circle1 As Circle, ByVal tolerance As System.Double) _
                As System.Boolean
            ...
            ''' <c>False</c>.</returns>
            Public Shared Function CirclesIntersect(ByVal circle0 As Circle,
                ByVal circle1 As Circle) As System.Boolean
            ...
            ''' </remarks>
            Public Shared Function TryCircleCircleIntersections(
            ByVal circle0 As Math.D2.Circle, ByVal circle1 As Math.D2.Circle,
            ByRef intersect0X As System.Double,
            ByRef intersect0Y As System.Double,
            ByRef intersect1X As System.Double,
            ByRef intersect1Y As System.Double) _
