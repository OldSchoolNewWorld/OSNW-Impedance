...
Public Class GenericCircle
    ...
    ''' 
    ''' </summary>
    ''' <param name="C1x">xxxxxxxxxx</param>
    ''' <param name="C1y">xxxxxxxxxx</param>
    ''' <param name="C1r">xxxxxxxxxx</param>
    ''' <param name="C2x">xxxxxxxxxx</param>
    ''' <param name="C2y">xxxxxxxxxx</param>
    ''' <param name="C2r">xxxxxxxxxx</param>
    ...
    Public Shared Function GetIntersections(ByVal C1x As System.Double,
        ...
        '        ' REF: Circle-Circle Intersection
        '        ' https://mathworld.wolfram.com/Circle-CircleIntersection.html
        '        ' Functions of circles.
        '        ' C1x^2 + C1y^2 = C1r^2
        '        ' C2x^2 + C2y^2 = C2r^2
        '        ' Find points that conform to both functions.

        ' The sequence below was generated by Visual Studio AI.
        ...
        Dim h As System.Double = Math.Sqrt(C1r * C1r - a * a)
        Dim x0 As System.Double = C1x + a * (DeltaX / DeltaCtr)
        Dim y0 As System.Double = C1y + a * (DeltaY / DeltaCtr)

        ' Two intersection points.
        Dim intersection1 As New System.Drawing.PointF(
            CSng(x0 + h * (DeltaY / DeltaCtr)), CSng(y0 - h * (DeltaX / DeltaCtr)))
    ...
    ''' <returns>A list of intersection points as <see cref="System.Drawing.PointF"/>
    ''' objects.</returns>
    ...
    ''' <summary>
    ''' Calculates the intersection points between this circle and
