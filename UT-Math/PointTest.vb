...
Public Class PointTests
    ...
    End Class ' TestDistance

    Public Class TestRotatedAround
        ...
        Const RAD390 As Double = 13.0 * PId / 6.0 ' 6.8067 (30+360)
        Const RAD480 As Double = 8.0 * PId / 3.0 ' 8.3776 (120+360)
        Const RAD600 As Double = 10.0 * PId / 3.0 ' 10.4720 (240+360)
        Const RAD675 As Double = 15.0 * PId / 4.0 ' 11.7810 (315+360)

        <Theory>
        <InlineData(RAD030, 5.0, 4.0, 3.0, 4.0, 4.7321, 5.0)> ' CCW 30.
        <InlineData(-RAD030, 5.0, 4.0, 3.0, 4.0, 4.7321, 3.0)> ' CW 30.
        <InlineData(RAD390, 5.0, 4.0, 3.0, 4.0, 4.7321, 5.0)> ' CCW 30+360.
        <InlineData(-RAD390, 5.0, 4.0, 3.0, 4.0, 4.7321, 3.0)> ' CW 30+360.
        <InlineData(RAD120, 5.0, 4.0, 3.0, 4.0, 2.0, 5.7321)>
        <InlineData(-RAD120, 5.0, 4.0, 3.0, 4.0, 2.0, 8.0 - 5.7321)>
        <InlineData(RAD480, 5.0, 4.0, 3.0, 4.0, 2.0, 5.7321)>
        <InlineData(-RAD480, 5.0, 4.0, 3.0, 4.0, 2.0, 8.0 - 5.7321)>
        <InlineData(RAD240, 5.0, 4.0, 3.0, 4.0, 2.0, 2.2679)>
        <InlineData(-RAD240, 5.0, 4.0, 3.0, 4.0, 2.0, 8.0 - 2.2679)>
        <InlineData(RAD600, 5.0, 4.0, 3.0, 4.0, 2.0, 2.2679)>
        <InlineData(-RAD600, 5.0, 4.0, 3.0, 4.0, 2.0, 8.0 - 2.2679)>
        <InlineData(RAD315, 5.0, 4.0, 3.0, 4.0, 4.4142, 2.5858)>
        <InlineData(-RAD315, 5.0, 4.0, 3.0, 4.0, 4.4142, 8.0 - 2.5858)>
        <InlineData(RAD675, 5.0, 4.0, 3.0, 4.0, 4.4142, 2.5858)>
        <InlineData(-RAD675, 5.0, 4.0, 3.0, 4.0, 4.4142, 8.0 - 2.5858)>
        ...
        Public Sub TestShifted(movingX As Double, movingY As Double, shiftX As System.Double,
                               shiftY As System.Double, expectedX As Double, expectedY As Double)
