...
' <Theory>
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,      999,     999,    999,     999,     999,    2.5,    6.5, RadiusR, RadiusX, RadiusG, RadiusB, RadiusV)> ' Outside of circle
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.0000,   1/2.0, 0.0000, -2.0000,     INF,    2.8,    6.6,  2.0000,  4.0000,     INF,   1.000,  2.0000)> ' C: Perimeter
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,      INF,  0.0000, 0.0000,  0.0000,     INF, 6.0000, 5.0000,  0.0000,     INF,  2.0000,     INF,  2.0000)> ' B: Open circuit
'
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000,  0.0000, 1.0000,  0.0000,  1.0000, 4.0000, 5.0000,  1.0000,     INF,  1.0000,     INF,  0.0000)> ' J: Center point
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000,  1.0000, 0.5000, -0.5000,  2.6180, 4.4000, 5.8000,  1.0000,  2.0000,   4.0/3,  4.0000,  0.8944)> ' On R=Z0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000, -2.0000, 0.2000,  0.4000,  5.8284, 5.0000, 4.0000,  1.0000,  1.0000,   5.0/3,  5.0000,  1.4142)> ' On R=Z0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000,   1/2.0, 0.4706, -0.1176,  2.1626, 4.7027, 5.2162,   2.0/3,  4.0000,  1.3600, 17.0000,  0.7352)> ' Q1: Inside R=Z0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000, 50.0000, 100.0000, 25.0000, 0.0094, -0.0024,  2.1626, 4.7027, 5.2162,   2.0/3,  4.0000,  1.3605, 16.6667,  0.7352)> ' Q2: Inside R=Z0 circle, above line, Z0=50
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   3.0000,  0.0000,  1.0/3,  0.0000,  3.0000, 5.0000, 5.0000,  0.5000,     INF,  1.5000,     INF,  1.0000)> ' Inside R=Z0 circle, on line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000, -2.0000, 0.2500,  0.2500,  4.2656, 5.0770, 4.3846,   2.0/3,  1.0000,  1.6000,  8.0000,  1.2404)> ' M: Inside R=Z0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,   1/2.0, 1.0000, -1.0000,  2.6180, 3.6000, 5.8000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' G=Y0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/2.0, 1.0000,  1.0000,  2.6180, 3.6000, 4.2000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' G=Y0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/3.0,  0.0000, 3.0000,  0.0000,  3.0000, 3.0000, 5.0000,  1.5000,     INF,  0.5000,     INF,  1.0000)> ' Inside G=Y0 circle, on line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/3.0,   1/3.0, 1.5000, -1.5000,  3.3699, 3.1765, 5.7059,  1.5000,  6.0000,  0.8000,  1.3333,  1.0846)> ' D1: Inside G=Y0, above line
'<InlineData(4.0000, 5.0000,   2.0000, 75.0000,  25.0000, 25.0000, 0.0200, -0.0200,  3.3699, 3.1765, 5.7059,  1.5000,  6.0000,  0.8000,  1.3333,  1.0846)> ' D2: NormZ 1/3 + j1/3, Z0=75
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/3.0, 1.3846,  0.9231,  2.2845, 3.4588, 4.4353,   4.0/3,  6.0000,  0.8387,  2.2500,  0.7822)> ' L: Inside G=Y0, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.2000,  1.4000, 0.1000, -0.7000, 14.9330, 4.5882, 6.6471,   5.0/3,  1.4286,  1.8182,  2.8571,  1.7489)> ' Top remainder
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.4000, -0.8000, 0.5000,  1.0000,  4.2656, 3.8462, 3.7692,  1.4286,  2.5000,   4.0/3,  2.0000,  1.2404)> ' Bottom remainder
...
Namespace TestImpedanceMath
    ...
    Public Class TestToAdmittance
        ...
        <InlineData(0.0000, 1 / 2.0, 0.0000, -2.0)> ' C: Perimeter
        ...
        <InlineData(2.0, 1 / 2.0, 0.4706, -0.1176)> ' Q1: Inside R=Z0 circle, above line
        <InlineData(100.0, 25.0, 0.0094, -0.0024)> ' Q2: Inside R=Z0 circle, above line, Z0=50
        ...
        <InlineData(1 / 3.0, 1 / 3.0, 1.5, -1.5)> ' D1: Inside G=Y0, above line
        <InlineData(25.0, 25.0, 0.02, -0.02)> ' D2: NormZ 1/3 + j1/3, Z0=75
        ...
        Sub ToAdmittance_BadInput_Fails1(r As Double, x As Double, expectG As Double, expectB As Double)
            Dim Ex As Exception = Assert.Throws(Of ArgumentOutOfRangeException)(
                Sub()
                    ' Code that throws the exception
                    Dim Imp As New Impedance(r, x)
        ...
        <InlineData(-2.0, 999, 999, 999)> ' NormR<=0
        <InlineData(INF, 0.0000, 0.0000, 0.0000)> ' B: Open circuit
        Sub ToAdmittance_BadInput_Fails2(r As Double, x As Double, expectG As Double, expectB As Double)
            Try
                ' Code that throws the exception.
                Dim Imp As New Impedance(r, x)
                Dim Y As Admittance = Imp.ToAdmittance()
    ...
    Public Class TestVSWR
        ...
        <InlineData(1.0, 2.0, 1 / 2.0, 2.1626)> ' Q1: Inside R=Z0 circle, above line
        <InlineData(50.0, 100.0, 25.0, 2.1626)> ' Q2: Inside R=Z0 circle, above line, Z0=50
        ...
        <InlineData(1.0, 1 / 3.0, 1 / 3.0, 3.3699)> ' D1: Inside G=Y0, above line
        <InlineData(75.0, 25.0, 25.0, 3.3699)> ' D2: NormZ 1/3 + j1/3, Z0=75
        ...
        <InlineData(1.0, INF, 0.0000)> ' B: Open circuit
        ...
        '<InlineData(1.0, 999, 999, 999)> ' Outside of circle
        <Theory>
        <InlineData(1.0, -2.0, 999, 999)> ' NormR<=0
        <InlineData(1.0, INF, 0.0000, INF)> ' B: Open circuit
        Sub VSWR_BadInput_Fails2(z0 As Double, r As Double, x As Double, expectVSWR As Double)
            Try
                ' Code that throws the exception.
                Dim Imp As New Impedance(r, x)
                Dim AnsVWSR As Double = Imp.VSWR(z0)
