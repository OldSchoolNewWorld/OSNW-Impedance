...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000,  1.0000, 0.5000, -0.5000,    4.4,    5.8,  1.0000,  2.0000,   4.0/3,  2.0000,  2.6180)> ' On R=Z0 circle, above line
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000,   1/2.0, 0.4706, -0.1176,  4.703, 5.2162,   2/3.0,  4.0000,  1.3600,       5,  2.1626)> ' Q1: Inside R=Z0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000, 50.0000, 100.0000, 25.0000, 0.0094, -0.0024,  4.703, 5.2162,   2/3.0,  4.0000,  1.3605,       5,  2.1626)> ' Q2: Inside R=Z0 circle, above line, Z0=50
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/3.0, 1.3846,  0.9231, 3.4588, 4.4353,   4/3.0,  6.0000,  0.8387,  1.0833,  2.2845)> ' L: Inside G=Y0, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.2000,  1.4000, 0.1000, -0.7000  4.5882, 6.6471,   5/3.0,  1.4286,  1.8182,  1.4286, 14.9330)> ' Top remainder
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.4000, -0.8000, 0.5000,  1.0000,  3.845,   3.75,  1.4286,     2.5,   4.0/3,     2.0,  4.2656)> ' Bottom remainder
