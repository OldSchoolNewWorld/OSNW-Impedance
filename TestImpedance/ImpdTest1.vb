...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.0000,   1/2.0,    INF,  2.0000,    2.8,    6.6,  2.0000,  4.0000,     INF,     1,     INF)> ' C: Perimeter
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000,  1.0000, 0.5000, -0.5000,    4.4,    5.8,  1.0000,  2.0000,   4.0/3,     4,  2.6180)> ' On R=Z0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   1.0000, -2.0000, 0.2000,  0.4000, 5.0000, 4.0000,  1.0000,  1.0000,   5.0/3,     5.5,  5.8284)> ' On R=Z0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000,   1/2.0, 0.4706, -0.1176,  4.703, 5.2162,   2/3.0,  4.0000,  1.3600,     17,  2.1626)> ' Q1: Inside R=Z0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000, 50.0000, 100.0000, 25.0000, 0.0094, -0.0024,  4.703, 5.2162,   2/3.0,  4.0000,  1.3605,     17,  2.1626)> ' Q2: Inside R=Z0 circle, above line, Z0=50
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000, -2.0000, 0.2500,  0.2500,  5.077,  4.385,   2.0/3,  1.0000,   1.600,     7.5,  4.2656)> ' M: Inside R=Z0 circle, below line
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/2.0, 1.0000,  1.0000,    3.6,    4.2,   4/3.0,  4.0000,  1.0000,     2.25,  2.6180)> ' G=Y0 circle, below line
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/3.0,   1/3.0, 1.5000, -1.5000,  3.175,    5.7,     1.5,     6.0,  0.8000,     1.5,  3.3699)> ' D1: Inside G=Y0, above line
'<InlineData(4.0000, 5.0000,   2.0000, 75.0000,  25.0000, 25.0000, 0.0200, -0.0200,  3.175,    5.7,     1.5,     6.0,  0.8000,     1.5,  3.3699)> ' D2: NormZ 1/3 + j1/3, Z0=75
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/3.0, 1.3846,  0.9231, 3.4588, 4.4353,   4/3.0,  6.0000,  0.8387,     2.75  2.2845)> ' L: Inside G=Y0, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.2000,  1.4000, 0.1000, -0.7000  4.5882, 6.6471,   5/3.0,  1.4286,  1.8182,     3, 14.9330)> ' Top remainder
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.4000, -0.8000, 0.5000,  1.0000,  3.845,   3.75,  1.4286,     2.5,   4.0/3,     2,  4.2656)> ' Bottom remainder
