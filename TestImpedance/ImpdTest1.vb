...
'<InlineData(4.0000, 5.0000,   2.0000, 50.0000, 100.0000, 25.0000, 0.0094, -0.0024,  2.1626, 4.7027, 5.2162,   2.0/3,  4.0000,  1.3605, 16.6667,  0.7352)> ' G2: Inside R=Z0 circle, above line, Z0=50
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   2.0000, -2.0000, 0.2500,  0.2500,  4.2656, 5.0770, 4.3846,   2.0/3,  1.0000,  1.6000,  8.0000,  1.2404)> ' I: Inside R=Z0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,   1/2.0, 1.0000, -1.0000,  2.6180, 3.6000, 5.8000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' J: On G=Y0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/2.0,  -1/2.0, 1.0000,  1.0000,  2.6180, 3.6000, 4.2000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' K: On G=Y0 circle, below line
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,    1/3.0,   1/3.0, 1.5000, -1.5000,  3.3699, 3.1765, 5.7059,  1.5000,  6.0000,  0.8000,  1.3333,  1.0846)> ' L1: Inside G=Y0 circle, above line
'<InlineData(4.0000, 5.0000,   2.0000, 75.0000,  25.0000, 25.0000, 0.0200, -0.0200,  3.3699, 3.1765, 5.7059,  1.5000,  6.0000,  0.8000,  1.3333,  1.0846)> ' L2: NormZ 1/3 + j1/3, Z0=75
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.2000,  1.4000, 0.1000, -0.7000, 14.9330, 4.5882, 6.6471,   5.0/3,  1.4286,  1.8182,  2.8571,  1.7489)> ' O: Top remainder
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.4000, -0.8000, 0.5000,  1.0000,  4.2656, 3.8462, 3.7692,  1.4286,  2.5000,   4.0/3,  2.0000,  1.2404)> ' P: Bottom remainder
...
Namespace TestImpedanceMath
    ...
    Public Class TestToAdmittance
        ...
        <InlineData(100.0, 25.0, 0.0094, -0.0024)> ' G2: Inside R=Z0 circle, above line, Z0=50
        <InlineData(3.0, 0.0000, 1.0 / 3, 0.0000)> ' H: Inside R=Z0 circle, on line
        <InlineData(2.0, -2.0, 0.25, 0.25)> ' I: Inside R=Z0 circle, below line
        <InlineData(1 / 2.0, 1 / 2.0, 1.0, -1.0)> ' J: On G=Y0 circle, above line
        <InlineData(1 / 2.0, -1 / 2.0, 1.0, 1.0)> ' K: On G=Y0 circle, below line
        <InlineData(1 / 3.0, 0.0000, 3.0, 0.0000)> ' M: Inside G=Y0 circle, on line
        <InlineData(1 / 3.0, 1 / 3.0, 1.5, -1.5)> ' L1: Inside G=Y0 circle, above line
        <InlineData(25.0, 25.0, 0.02, -0.02)> ' L2: NormZ 1/3 + j1/3, Z0=75
        <InlineData(1 / 2.0, -1 / 3.0, 1.3846, 0.9231)> ' N: Inside G=Y0 circle, below line
        <InlineData(0.2, 1.4, 0.1, -0.7)> ' O: Top remainder
        <InlineData(0.4, -0.8, 0.5, 1.0)> ' P: Bottom remainder
        ...
        '<InlineData(999, 999, 999, 999)> ' Outside of main circle
        <Theory>
        <InlineData(-2.0, 999, 999, 999)> ' NormR<=0
        <InlineData(INF, 0.0000, 0.0000, 0.0000)> ' C: Open circuit
    ...
    Public Class TestVSWR
        ...
        <InlineData(50.0, 100.0, 25.0, 2.1626)> ' G2: Inside R=Z0 circle, above line, Z0=50
        <InlineData(1.0, 3.0, 0.0000, 3.0)> ' H: Inside R=Z0 circle, on line
        <InlineData(1.0, 2.0, -2.0, 4.2656)> ' I: Inside R=Z0 circle, below line
        <InlineData(1.0, 1 / 2.0, 1 / 2.0, 2.618)> ' J: On G=Y0 circle, above line
        <InlineData(1.0, 1 / 2.0, -1 / 2.0, 2.618)> ' K: On G=Y0 circle, below line
        <InlineData(1.0, 1 / 3.0, 0.0000, 3.0)> ' M: Inside G=Y0 circle, on line
        <InlineData(1.0, 1 / 3.0, 1 / 3.0, 3.3699)> ' L1: Inside G=Y0 circle, above line
        <InlineData(75.0, 25.0, 25.0, 3.3699)> ' L2: NormZ 1/3 + j1/3, Z0=75
        <InlineData(1.0, 1 / 2.0, -1 / 3.0, 2.2845)> ' N: Inside G=Y0 circle, below line
        <InlineData(1.0, 0.2, 1.4, 14.933)> ' O: Top remainder
        <InlineData(1.0, 0.4, -0.8, 4.2656)> ' P: Bottom remainder
        ...
        '<InlineData(1.0, 999, 999, 999)> ' Outside of main circle
        <Theory>
        <InlineData(1.0, -2.0, 999, 999)> ' NormR<=0
        <InlineData(1.0, INF, 0.0000, INF)> ' C: Open circuit
