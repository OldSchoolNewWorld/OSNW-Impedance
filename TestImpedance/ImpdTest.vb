...
'<InlineData( 1.0,   1.0000,    1.0000, 0.4472, 0.2000, 1.2649,  0.800,   63.4349,  18.4350,  2.6180)> ' E1: On R=Z0 circle, above resonance line.
'<InlineData(50.0,  50.0000,   50.0000, 0.4472, 0.2000, 1.2649,  0.800,   63.4349,  18.4350,  2.6180)> ' E50: On R=Z0 circle, above resonance line. Z0=50.
'<InlineData( 1.0,   1.0000,   -2.0000, 0.7071, 0.5000, 1.5811, 0.5000,  -45.0000, -18.4350,  5.8284)> ' F1: On R=Z0 circle, below resonance line.
'<InlineData(50.0,  50.0000, -100.0000, 0.7071, 0.5000, 1.5811, 0.5000,  -45.0000, -18.4350,  5.8284)> ' F50: On R=Z0 circle, below resonance line. Z0=50.
...
'<InlineData( 1.0,    1/2.0,     1/2.0, 0.4472, 0.2000, 0.8944, 0.8000,  116.5651,  26.5651,  2.6180)> ' J1: On G=Y0 circle, above resonance line.
'<InlineData(50.0,  25.0000,   25.0000, 0.4472, 0.2000, 0.8944, 0.8000,  116.5651,  26.5651,  2.6180)> ' J50: On G=Y0 circle, above resonance line. Z0=50.
'<InlineData( 1.0,    1/2.0,    -1/2.0, 0.4472, 0.2000, 0.8944, 0.8000, -116.5651, -26.5651,  2.6180)> ' K1: On G=Y0 circle, below resonance line.
'<InlineData(50.0,  25.0000,  -25.0000, 0.4472, 0.2000, 0.8944, 0.8000, -116.5651, -26.5651,  2.6180)> ' K50: On G=Y0 circle, below resonance line. Z0=50.
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0,   1.0000,    1.0000,   0.5000,   -0.5000, 4.4000, 5.8000,  1.0000,  2.0000,   4.0/3,  4.0000,  0.8944)> ' E1: On R=Z0 circle, above resonance line.
'<InlineData(4.0000, 5.0000,   2.0000, 50.0,  50.0000,   50.0000,   0.0100,   -0.0100, 4.4000, 5.8000,  1.0000,  2.0000,   4.0/3,  4.0000,  0.8944)> ' E50: On R=Z0 circle, above resonance line. Z0=50.
'<InlineData(4.0000, 5.0000,   2.0000,  1.0,   1.0000,   -2.0000,   0.2000,    0.4000, 5.0000, 4.0000,  1.0000,  1.0000,   5.0/3,  5.0000,  1.4142)> ' F1: On R=Z0 circle, below resonance line.
'<InlineData(4.0000, 5.0000,   2.0000, 50.0,  50.0000, -100.0000,   0.0040,    0.0080, 5.0000, 4.0000,  1.0000,  1.0000,   5.0/3,  5.0000,  1.4142)> ' F50: On R=Z0 circle, below resonance line. Z0=50.
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0,    1/2.0,     1/2.0,   1.0000,   -1.0000, 3.6000, 5.8000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' J1: On G=Y0 circle, above resonance line.
'<InlineData(4.0000, 5.0000,   2.0000, 50.0,  25.0000,   25.0000,   0.0200,   -0.0200, 3.6000, 5.8000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' J50: On G=Y0 circle, above resonance line. Z0=50.
'<InlineData(4.0000, 5.0000,   2.0000,  1.0,    1/2.0,    -1/2.0,   1.0000,    1.0000, 3.6000, 4.2000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' K1: On G=Y0 circle, below resonance line.
'<InlineData(4.0000, 5.0000,   2.0000, 50.0,  25.0000,  -25.0000,   0.0200,    0.0200, 3.6000, 4.2000,   4.0/3,  4.0000,  1.0000,  2.0000,  0.8944)> ' K50: On G=Y0 circle, below resonance line. Z0=50.
...
Namespace MathTests
    ...
    Public Class TestToAdmittance
        ...
        <InlineData(1.0, -2.0, 0.2, 0.4)> ' F1: On R=Z0 circle, below resonance line.
        ...
        <InlineData(1 / 2.0, 1 / 2.0, 1.0, -1.0)> ' J1: On G=Y0 circle, above resonance line.
        <InlineData(1 / 2.0, -1 / 2.0, 1.0, 1.0)> ' K1: On G=Y0 circle, below resonance line.
