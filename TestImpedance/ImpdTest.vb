...
'<InlineData( 1.0000,   0.2000,  1.4000, 0.8745, 0.7647, 1.5340, 0.2353,  70.34617,  32.4712, 14.9330)> ' O: In the top center.
'<InlineData( 1.0000,   0.4000, -0.8000, 0.6200, 0.3846, 1.1094, 0.6154,  -97.1250, -33.6901,  4.2656)> ' P: In the bottom center.
...
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.2000,  1.4000,  0.1000,  -0.7000, 4.5882, 6.6471,   5.0/3,  1.4286,  1.8182,  2.8571,  1.7489)> ' O: In the top center.
'<InlineData(4.0000, 5.0000,   2.0000,  1.0000,   0.4000, -0.8000,  0.5000,   1.0000, 3.8462, 3.7692,  1.4286,  2.5000,   4.0/3,  2.0000,  1.2404)> ' P: In the bottom center.
...
Namespace MathTests
    ...
    Public Class TestToAdmittance
        ...
        <InlineData(0.2, 1.4, 0.1, -0.7)> ' O: In the top center.
        <InlineData(0.4, -0.8, 0.5, 1.0)> ' P: In the bottom center.
